#!/bin/bash
# Camp v0.1
# coded by: github.com/Vallofe/camp
...
printf " \e[1;77m v1.0 coded by github.com/Vallofe/camp\e[0m \n"
...
sed 's+forwarding_link+'$link'+g' camp.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' camp.html > index2.html
